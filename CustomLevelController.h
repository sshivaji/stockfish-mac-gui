...
@interface CustomLevelController : NSWindowController {
  IBOutlet id blackInitialTime;
  IBOutlet id blackMoveBonus;
  IBOutlet id whiteInitialTime;
  IBOutlet id whiteMoveBonus;
