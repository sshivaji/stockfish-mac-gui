...
@interface EngineConfigController : NSWindowController {
  IBOutlet NSTableView *optionsTable;
  IBOutlet NSBox *currentOptionBox;
  IBOutlet NSTextField *currentOptionName;
  IBOutlet NSTextField *currentOptionInfo;
  IBOutlet id bookChoicePopup;
  IBOutlet id bookVarietyPopup;
  id control;
